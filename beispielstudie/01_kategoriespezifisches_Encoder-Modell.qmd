...
Als kategoriespezifisches Encoder-Modell wurde das off-the-shelf Modell *German Sentiment Bert* von @guhrTrainingBroadcoverageGerman2020 ausgewählt. Dieses Modell basiert auf German BERT [@deepsetGermanBERTState2019], einem mit deutschsprachigen Texten trainierten Encoder-Modell, das anschließend mit Hilfe von 1.834 Millionen gelabelten deutschen Texten verschiedenster Textsorten für die Sentimentanalyse weiter trainiert wurde [vgl. @guhrTrainingBroadcoverageGerman2020, S. 1628–1629]. Obwohl @guhrTrainingBroadcoverageGerman2020 vor der Anwendung eine Textbereinigung vorschlagen (z. B. Entfernen von URLs), wurde das Modell in der vorliegenden Studie – wie auch alle weiteren LLM-basierten Modelle – ohne Preprocessing genutzt, da diese Modelle i. d. R. sehr gut mit unbereinigten Daten umgehen können [vgl. @tornbergHowUseLLMs2023] und wir daran interessiert waren, die off-the-shelf Anwendung der Modelle zu evaluieren (d. h., ohne aufwändige Vorbereitung). Eine Robustheitsanalyse ergab zudem, dass die Leistung durch Preprocessing oder Aufteilung langer Texte nur geringfügig und nicht konsistent verbessert werden konnte.
